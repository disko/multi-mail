...
def test_list_renders_scripts_with_active_marker(fake):
    ...
    result = run(
        email_mcp.email_sieve_list(email_mcp.SieveListInput(account_id=ACCT_ID))
    )
...
def test_get_returns_script_in_code_fence(fake):
    ...
    result = run(
        email_mcp.email_sieve_get(
            email_mcp.SieveGetInput(
                account_id=ACCT_ID,
                script_name="vacation",
            )
        )
    )
...
def test_activate_sets_named_script_active(fake):
    fake.scripts = {"a": "...", "b": "..."}
    result = run(
        email_mcp.email_sieve_activate(
            email_mcp.SieveActivateInput(
                account_id=ACCT_ID,
                script_name="a",
            )
        )
...
def test_delete_removes_inactive_script(fake):
    fake.scripts = {"old": "..."}
    result = run(
        email_mcp.email_sieve_delete(
            email_mcp.SieveDeleteInput(
                account_id=ACCT_ID,
                script_name="old",
            )
        )
